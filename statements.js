let statements = [
    {
        ...
        'confirmation': `<strong>Correct.</strong><br>All time loops require clearance from the TRA.<br>Recreational time 
            travel is illegal.`,
        'correction': `<strong>Incorrect.</strong><br>All time loops require clearance from the TRA.<br>Recreational time 
            travel is illegal.`,
    },
    {
        ...
        'correction': `<strong>Incorrect.</strong><br>For the sake of timeline consistency, all time loops are 
            confidential.<br>Telling anyone you are currently looping is a highly chaotic event, and illegal.`,
    },
    {
        ...
        'correction': `<strong>Incorrect.</strong><br>Any time loop, no matter how short they seem to you, can create 
            massive anomalies in time that are impossible to predict.<br>That's  why the TRA has made it our mission to 
            make time travel as safe and controlled as possible.`,
    },
    {
        ...
        'correction': `<strong>Incorrect.</strong><br>During your time loop, ANY anomalies you notice, no matter how 
             trivial, must be reported ANONYMOUSLY to the TRA hotline as soon as they are noticed.`,
    },
    {
        ...
        'correction': `<strong>Incorrect.</strong><br>People with the ability to travel through time are only able to 
             travel backwards within their own timeline.<br>As far as we know, time travel into the future is impossible.`,
    },
]